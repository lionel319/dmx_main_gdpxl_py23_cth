...
class QueryDictTests(unittest.TestCase):
    ...
    def test_single_key_value(self):
        ...
        self.assertEqual(list(q.items()), [(u'foo', u'bar')])
    ...
    def test_basic_mutable_operations(self):
        ...
        self.assertEqual(list(q.items()),  [(u'foo', u'another'), (u'name', u'john')])
        self.assertEqual(q.lists(), [(u'foo', [u'bar', u'baz', u'another']), (u'name', [u'john'])])
        self.assertEqual(list(q.keys()), [u'foo', u'name'])
        self.assertEqual(list(q.values()), [u'another', u'john'])
    ...
    def test_multiple_keys(self):
        ...
        self.assertEqual('foo' in q, False)
        self.assertEqual('foo' in q, False)
        self.assertEqual(list(q.items()), [(u'vote', u'no')])
        self.assertEqual(q.lists(), [(u'vote', [u'yes', u'no'])])
        self.assertEqual(list(q.keys()), [u'vote'])
        self.assertEqual(list(q.values()), [u'no'])
        self.assertEqual(len(q), 1)
