...
class TranslationTests(TestCase):
    ...
    def test_string_concat(self):
        ...
        self.assertEqual(u'django', str(django.utils.translation.string_concat("dja", "ngo")))
    ...
    def test_l10n_disabled(self):
        ...
        try:
            ...
            self.assertEqual(
                ...
                SelectDateWidget(years=list(range(2009, 2019))).render('mydate', datetime.date(2009, 12, 31))
            )
