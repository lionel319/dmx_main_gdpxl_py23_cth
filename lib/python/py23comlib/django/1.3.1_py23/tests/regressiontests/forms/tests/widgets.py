...
<li><label><input type="radio" name="escape" value="good" /> you &gt; me</label></li>
        ...
        # Unicode choices are correctly rendered as HTML
        w = RadioSelect()
        self.assertEqual(str(w.render('email', 'ŠĐĆŽćžšđ', choices=[('ŠĐĆŽćžšđ', 'ŠĐabcĆŽćžšđ'), ('ćžšđ', 'abcćžšđ')])), u'<ul>\n<li><label><input checked="checked" type="radio" name="email" value="\u0160\u0110\u0106\u017d\u0107\u017e\u0161\u0111" /> \u0160\u0110abc\u0106\u017d\u0107\u017e\u0161\u0111</label></li>\n<li><label><input type="radio" name="email" value="\u0107\u017e\u0161\u0111" /> abc\u0107\u017e\u0161\u0111</label></li>\n</ul>')
...
<li><label><input type="checkbox" name="escape" value="good" /> you &gt; me</label></li>
        ...
        # Each input gets a separate ID
        self.assertEqual(CheckboxSelectMultiple().render('letters', list('ac'), choices=list(zip(list('abc'), list('ABC'))), attrs={'id': 'abc'}), """<ul>
