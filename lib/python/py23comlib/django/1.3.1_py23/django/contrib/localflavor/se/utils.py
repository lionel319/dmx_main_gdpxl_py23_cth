...
def format_personal_id_number(birth_day, gd):
    ...
    return str(str(birth_day.year) + gd['month'] + gd['day'] + gd['serial'] + gd['checksum'])
...
def format_organisation_number(gd):
    ...
    return str(century + gd['year'] + gd['month'] + gd['day'] + gd['serial'] + gd['checksum'])
