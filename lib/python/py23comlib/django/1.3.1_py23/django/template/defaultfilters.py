...
def floatformat(text, arg=-1):
    ...
    * {{ num3|floatformat:"-3" }} displays "34.260"
    ...
    if p == 0:
        ...
        exp = old_div(Decimal(u'1.0'), (Decimal(10) ** abs(p)))
    try:
...
def filesizeformat(bytes):
    ...
    if bytes < 1024 * 1024 * 1024 * 1024 * 1024:
        return ugettext("%s TB") % filesize_number_format(old_div(bytes, (1024 * 1024 * 1024 * 1024)))
    return ugettext("%s PB") % filesize_number_format(old_div(bytes, (1024 * 1024 * 1024 * 1024 * 1024)))
