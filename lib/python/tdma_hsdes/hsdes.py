"""
Filename:      $Header: //depot/da/infra/dmx/main_gdpxl_py23_cth/lib/python/tdma_hsdes/hsdes.py#1 $
...
class Lookup(object):
    ...
    def get_lookup_data(self, field, count=10000 ):                
        try:
            ...
            arg = 'lookup/%s?start_at=1&tenantlist=fpga&max_results=%i' % (field, count)
            data = {}
