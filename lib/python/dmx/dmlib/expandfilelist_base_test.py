...
# $Header: //depot/da/infra/dmx/main_gdpxl_py23_cth/lib/python/dmx/dmlib/expandfilelist_base_test.py#1 $
...
import unittest
import doctest
import dmx.dmlib.expandfilelist_base

def load_tests(loader, tests, ignore): # pylint: disable=W0613
    '''Load the FileListExpander.py doctest tests into unittest.'''
    tests.addTests(doctest.DocTestSuite(dmx.dmlib.expandfilelist_base))
    return tests

class ExpandFilelistBase(unittest.TestCase): # pylint: disable=R0904
    """Test the ExpandFilelistBase class."""
