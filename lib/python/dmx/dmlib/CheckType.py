...
# $Header: //depot/da/infra/dmx/main_gdpxl_py23_cth/lib/python/dmx/dmlib/CheckType.py#3 $
...
class CheckType(CheckerBase):
    ...
    def __init__(self, icmws, ip, cell, roadmap='', prel=None):
        super(CheckType, self).__init__(icmws, ip, cell)
    ...
    def _checkFilelist(self, deliverableName):
        ...
        '''
        filelists = self._ip.get_deliverable(deliverableName, roadmap=self._roadmap).get_filelists(ip=self.ip_name,
            cell=self.cell_name)
