...
#
# $Header: //depot/da/infra/dmx/main_gdpxl_py23_cth/lib/python/dmx/dmlib/deliverables_test/checkdata_good2/CheckVsPREDECESSOR_GOOD1.py#1 $
...
class Check(unittest.TestCase): #pylint: disable-msg=R0904
    ...
    def test_alwaysPass(self):
        ...
        self.assertTrue(True, 'CHECKDATA_GOOD2 vs. PREDECESSOR_GOOD1 context check that always passes')
