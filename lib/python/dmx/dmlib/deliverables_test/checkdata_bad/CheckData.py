...
#
# $Header: //depot/da/infra/dmx/main_gdpxl_py23_cth/lib/python/dmx/dmlib/deliverables_test/checkdata_bad/CheckData.py#1 $
...
class Check(unittest.TestCase): #pylint: disable-msg=R0904
    ...
    def test_alwaysFail(self):
        ...
        self.assertTrue(False, 'CHECKDATA_BAD data check that always fails')
