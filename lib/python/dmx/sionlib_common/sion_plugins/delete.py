...
class DeleteRunner(Runner):
    ...
    def run(self):
        ...
        ret = run_as_psginfraadm(dir = self.dir, command = self.command, user = self.user)
...
class Delete(Command):
    ...
    def get_help(cls):
        ...
        return 'Removes ICM data synced by icmrelreader from a user\'s local directory'
    ...
    def extra_help(cls):
        ...
        myhelp = '''\
            Description
            ===========
            Sion delete allows user to delete ICM data synced by icmrelreader.            
            ...
            Deletes ICM data populated by icmrelreader onto user's local directory
           
            Example
            =====
            sion delete -d /home/kwlim/i14socnd/ar_lib/dev
            Deletes the directory dev from /home/kwlim/i14socnd/ar_lib. Delete will only be successful if this directory is created by icmrelreader.
            '''
