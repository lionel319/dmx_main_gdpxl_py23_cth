...
#
# $File: //depot/da/infra/dmx/main_gdpxl_py23_cth/armor_tests/whr/test_immutable_config_rules.py $
# $Revision: #1 $
# $Change: 7411538 $
...
class TestRELCreation(unittest.TestCase):
    ...
    def test_standard_user_cannot_create_simple_REL_in_whr(self):
        '''
        Tests that a standard user cannot create a simple REL config within the whr project
        '''
                      
        with run_as_user(self.standard_user):
            with self.assertRaises(ICManageError):       
                self.cli.add_simple_config('whr', 'armor_testing', 'rtl', 'REL1.0ND5revA__15ww123a',
                                           '#ActiveDev')

    def test_standard_user_cannot_create_composite_REL_in_whr(self):
        '''
        Tests that a standard user cannot create a composite REL config within the whr project
        '''
        simple_config = 'dev@rtl'
        with run_as_user(self.standard_user):
            with self.assertRaises(ICManageError):
                self.cli.add_composite_config('whr', 'armor_testing', 'REL1.0ND5revA__15ww123a',
                                              [simple_config])

    def test_standard_user_cannot_create_simple_snap_in_whr(self):
        '''
        Tests that a standard user cannot create a simple snap- config within the whr project
        '''
        ...
        with run_as_user(self.standard_user):
            command = ['pm', 'configuration', '-t', 'rtl', 'whr', 'armor_testing',
    ...
    def test_standard_user_cannot_create_composite_snap_in_whr(self):
        '''
        Tests that a standard user cannot create a composite snap config within the whr project
        '''
        simple_config = 'dev@rtl'
        ...
        with run_as_user(self.standard_user):
            # We need to invoke pm directly
            command = ['pm', 'configuration', 'whr', 'armor_testing',
    ...
    def test_icetnr_can_create_simple_REL_in_whr(self):
        '''
        Tests that the icetnr user can create a simple REL config within the whr project
        '''
        project = 'whr'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_icetnr_can_create_composite_REL_in_whr(self):
        '''
        Tests that the icetnr user can create a composite REL config within the whr project
        '''
        project = 'whr'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_immutable_can_create_simple_snap_in_whr(self):
        '''
        Tests that the immutable user can create a simple snap config within the whr project
        '''
        project = 'whr'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_immutable_can_create_composite_snap_in_whr(self):
        '''
        Tests that the immutable user can create a composite snap config within the whr project
        '''
        project = 'whr'
        variant = 'armor_testing'
        libtype = 'rtl'
