...
# non-Altera purposes.
#
# Tests the whr librarian IC Manage armor rules
#
# $File: //depot/da/infra/dmx/main_gdpxl_py23_cth/armor_tests/whr/_test_wharfrock_librarian_rules.py $
# $Revision: #1 $
# $Change: 7411538 $
...
class TestwhrIntegratorRUles(unittest.TestCase):
    '''
    Tests the IC Manage rules applied to the whr.librarian Perforce group
    '''

    def setUp(self):
        self.cli = ICManageCLI()
        self.user = 'whrlibrarian'
        self.prefix = 'whr_librarian_testing'
    ...
    def test_whr_librarian_can_create_variant_in_whr(self):
        '''
        Tests that a whr_librarian can create a variant in the whr project
        '''
        project = 'whr'
    ...
    def test_whr_librarian_cannot_delete_variant_in_whr(self):
        '''
        Tests that a whr_librarian cannot delete a variant in the whr project
        '''
        project = 'whr'
        variant = 'this_should_get_added'
    ...
    def test_whr_librarian_can_add_libtype_to_variant_in_whr(self):
        '''
        Tests that a whr_librarian can add a libtype to a variant in whr
        '''
        project = 'whr'
    ...
    def test_whr_librarian_can_add_library_in_whr(self):
        '''
        Tests that a whr librarian can add a library within the whr project
        '''
        project = 'whr'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_whr_librarian_can_branch_a_library_in_whr(self):
        '''
        Tests that a whr librarian can branch an IC Manage library within the whr project
        '''
        project = 'whr'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_whr_librarian_cannot_delete_library_in_whr(self):
        '''
        Tests that a whr librarian cannot delete an IC Manage library within the whr project
        '''
        project = 'whr'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_whr_librarian_can_edit_ipspec(self):
        project = 'whr'                
        variant = 'armor_testing'
        libtype = 'ipspec'
        config = 'dev'
