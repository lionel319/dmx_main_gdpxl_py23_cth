...
#
# $File: //depot/da/infra/dmx/main_gdpxl_py23_cth/armor_tests/synopsys/test_standard_user_rules.py $
# $Revision: #1 $
# $Change: 7411538 $
...
class TestStandardUserRules(unittest.TestCase):
    '''
    Tests the operations that standard users can/cannot perform in Synopsys
    '''
    def setUp(self):
    ...
    def _test_standard_user_cannot_create_variant_in_Synopsys(self):
        '''
        Tests that a standard user cannot create a variant in the Synopsys project
        '''
        project = 'Synopsys'
    ...
    def test_standard_user_can_add_libtype_to_variant_in_Synopsys(self):
        '''
        Tests that a standard user can add a libtype to a variant in Synopsys
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'ipspec'
    ...
    def test_standard_user_can_add_libraries_in_Synopsys(self):
        '''
        Tests that a standard user can add a library in Synopsys
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_standard_user_can_branch_libraries_in_Synopsys(self):
        '''
        Tests that a standard user can branch a library in Synopsys
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_standard_user_cannot_delete_a_library_in_Synopsys(self):
        '''
        Tests that a standard user cannot delete a library in Synopsys
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_standard_user_can_create_mutable_simple_config_in_Synopsys(self):
        '''
        Tests that a standard user can create a mutable simple config in Synopsys
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_standard_user_can_create_mutable_composite_config_in_Synopsys(self):
        '''
        Tests that a standard user can create a mutable composite config in Synopsys
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_standard_user_can_create_a_library_release_in_Synopsys(self):
        '''
        Tests that a standard user can create a library release in Synopsys
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def _test_standard_user_cannot_edit_ipspec(self):
        ...
        libtype = 'ipspec'
        config = 'dev'
        wsdir = os.path.realpath('/p/psg/da/infra/regression/synopsys/{}'.format(os.getenv('USER')))
        orig_cwd = os.getcwd()
    ...
    # The following tests are ported from test_synopsys_librarian_rules
    def test_standard_user_can_create_variant_in_Synopsys(self):
        '''
        Tests that a standard_user can create a variant in the Synopsys project
        '''
        project = 'Synopsys'
    ...
    def test_standard_user_cannot_delete_variant_in_Synopsys(self):
        '''
        Tests that a standard_user cannot delete a variant in the Synopsys project
        '''
        project = 'Synopsys'
        variant = 'this_should_get_added'
    ...
    def test_standard_user_can_add_libtype_to_variant_in_Synopsys(self):
        '''
        Tests that a standard_user can add a libtype to a variant in Synopsys
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'ipspec'
    ...
    def test_standard_user_can_add_library_in_Synopsys(self):
        '''
        Tests that a Synopsys standard user can add a library within the Synopsys project
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_standard_user_can_branch_a_library_in_Synopsys(self):
        '''
        Tests that a Synopsys standard user can branch an IC Manage library within the Synopsys project
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_standard_user_cannot_delete_library_in_Synopsys(self):
        '''
        Tests that a Synopsys standard user cannot delete an IC Manage library within the Synopsys project
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'rtl'
