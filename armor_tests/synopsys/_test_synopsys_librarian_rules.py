...
# non-Altera purposes.
#
# Tests the Synopsys librarian IC Manage armor rules
#
# $File: //depot/da/infra/dmx/main_gdpxl_py23_cth/armor_tests/synopsys/_test_synopsys_librarian_rules.py $
# $Revision: #1 $
# $Change: 7411538 $
...
class TestSynopsysIntegratorRUles(unittest.TestCase):
    '''
    Tests the IC Manage rules applied to the Synopsys.librarian Perforce group
    '''

    def setUp(self):
        self.cli = ICManageCLI()
        self.user = 'synopsyslibrarian'
        self.prefix = 'synopsys_librarian_testing'
    ...
    def test_Synopsys_librarian_can_create_variant_in_Synopsys(self):
        '''
        Tests that a Synopsys_librarian can create a variant in the Synopsys project
        '''
        project = 'Synopsys'
    ...
    def test_Synopsys_librarian_cannot_delete_variant_in_Synopsys(self):
        '''
        Tests that a Synopsys_librarian cannot delete a variant in the Synopsys project
        '''
        project = 'Synopsys'
        variant = 'this_should_get_added'
    ...
    def test_Synopsys_librarian_can_add_libtype_to_variant_in_Synopsys(self):
        '''
        Tests that a Synopsys_librarian can add a libtype to a variant in Synopsys
        '''
        project = 'Synopsys'
    ...
    def test_Synopsys_librarian_can_add_library_in_Synopsys(self):
        '''
        Tests that a Synopsys librarian can add a library within the Synopsys project
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_Synopsys_librarian_can_branch_a_library_in_Synopsys(self):
        '''
        Tests that a Synopsys librarian can branch an IC Manage library within the Synopsys project
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_Synopsys_librarian_cannot_delete_library_in_Synopsys(self):
        '''
        Tests that a Synopsys librarian cannot delete an IC Manage library within the Synopsys project
        '''
        project = 'Synopsys'
        variant = 'armor_testing'
        libtype = 'rtl'
    ...
    def test_Synopsys_librarian_can_edit_ipspec(self):
        project = 'Synopsys'                
        variant = 'armor_testing'
        libtype = 'ipspec'
        config = 'dev'
