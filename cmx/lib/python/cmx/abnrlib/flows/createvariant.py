#!/usr/bin/env python
'''
$Header: //depot/da/infra/dmx/main_gdpxl_py23_cth/cmx/lib/python/cmx/abnrlib/flows/createvariant.py#2 $
$Change: 7808991 $
...
class CreateVariant():
    ...
    def run(self):
        ...
        repopath = '/nfs/site/disks/psg.git.001/git_repos/{}'.format(self.args.ip)
