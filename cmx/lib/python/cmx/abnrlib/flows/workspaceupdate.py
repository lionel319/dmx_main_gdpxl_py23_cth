#!/usr/bin/env python
'''
$Header: //depot/da/infra/dmx/main_gdpxl_py23_cth/cmx/lib/python/cmx/abnrlib/flows/workspaceupdate.py#4 $
$Change: 7504062 $
...
class WorkspaceUpdate(object):
    ...
    def __init__(self, cfgfile='', deliverables=None, original_user='', preview=False, force=False):
        self.force = force
