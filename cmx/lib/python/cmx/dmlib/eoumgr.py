...
class EOUMGRError(Exception): pass
...
class EOUMGR(DMBase):
    ...
    def __init__(self, stages=None):
        ...
        # cp_dict = config_parser.read('../../constants/arcplwrapper.ini')
        ...
        stages = stages if stages else os.environ.get('DMX_EOUMGR_BUNDLES', 'all').split(',')
        super().__init__(stages, 'r2g', cmd_options)
        self.logger = LOGGER
